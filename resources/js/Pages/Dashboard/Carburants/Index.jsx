...
export default function Index({ auth, carburants, page_id, page_subid, page_title, page_subtitle, search_text = '' }) {
        ...
        <DashboardLayout auth={auth} page_id={page_id} page_subid={page_subid}>
            ...
            <Card className="h-full w-full">
                ...
                <CardBody className={" p-0 overflow-auto"}>
                    <ViewTable  head={TABLE_HEAD} links={carburants.links} showHead={showHead}>
                                    ...
                                    <tr className='hover:bg-gray-100 transition-all duration-500' key={id}>
                                        <td className={classes}>
                                            <div className="flex items-center gap-3">
                                                ...
                                                {photo && <Link href={route('dashboard.carburants.show', id)}><Avatar src={HTTP_FRONTEND_HOME + '' + photo} alt={nom} className='w-10 bg-white' size="sm" /></Link>}
                                        ...
                                        <td className={classes}>
                                            <div className="flex flex-col">
                                                <Typography
                                                    ...
                                                    className="font-bold"
                                                >
                                                    <Link href={route('dashboard.carburants.show', id)}>
                                                        {nom}
                                                    </Link>
                                                </Typography>
                                            </div>
