    ...
    return (
        <>
            <div className="max-w-screen-xl mx-auto p-4">
                ...
                <div className='  my-6'>
                    <Link href={route('front.achats')} className=' items-center px-0 mx-auto flex bg-white hover:opacity-70   text-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold   text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'>
