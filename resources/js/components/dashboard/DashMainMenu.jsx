  ...
  return (
    ...
    <div className="flex py-12 min-h-full sm:border-r md:pe-4 flex-col gap-2 max-w-[280px] mx-auto ">
                ...
                <Menudropdown.Trigger>
                    <span className="inline-flex w-full ">
                        ...
                        >
                            ...
                            <svg class="w-4 h-4 ms-2  text-gray-500 transition group-open:rotate-90" xmlns="http://www.w3.org/2000/svg"  fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"></path></svg>
          ...
          <Menudropdown>
                ...
                <Menudropdown.Content>
                    <Menudropdown.Link className='flex' href={route('dashboard')}> Listes</Menudropdown.Link>
